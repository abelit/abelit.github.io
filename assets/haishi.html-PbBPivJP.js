import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as s,f as a}from"./app-C7nDDXNs.js";const i={},l=a(`<h2 id="基本信息" tabindex="-1"><a class="header-anchor" href="#基本信息"><span>基本信息</span></a></h2><h3 id="kubernetes-节点信息-旧" tabindex="-1"><a class="header-anchor" href="#kubernetes-节点信息-旧"><span>Kubernetes 节点信息（旧）</span></a></h3><table><thead><tr><th>主机名称</th><th>IP 地址</th><th>用途</th><th>组件</th><th>版本</th></tr></thead><tbody><tr><td>node-010010013100</td><td>10.81.40.138</td><td>master 节点</td><td>kube-apiserver,kube-scheduler,etcd,kube-controller-manager,kubectl,kubelet,kubeadm</td><td>v1.22.5</td></tr><tr><td>node-010010013103</td><td>10.10.13.103</td><td>worker 节点</td><td>kube-proxy,kubelet,kubeadm</td><td>v1.22.5</td></tr><tr><td>node-010010013104</td><td>10.10.13.104</td><td>worker 节点</td><td>kube-proxy,kubelet,kubeadm</td><td>v1.22.5</td></tr><tr><td>node-010010013105</td><td>10.10.13.105</td><td>worker 节点</td><td>kube-proxy,kubelet,kubeadm</td><td>v1.22.5</td></tr></tbody></table><h3 id="kubernetes-节点信息-新" tabindex="-1"><a class="header-anchor" href="#kubernetes-节点信息-新"><span>Kubernetes 节点信息（新）</span></a></h3><table><thead><tr><th>主机名称</th><th>IP 地址</th><th>用途</th><th>组件</th><th>版本</th></tr></thead><tbody><tr><td>node-010010013100</td><td>10.81.40.138, 10.10.13.200 (vip)</td><td>master 节点</td><td>kube-apiserver,kube-scheduler,etcd,kube-controller-manager,kubectl,kubelet,kubeadm,keepalive,haproxy</td><td>v1.22.5</td></tr><tr><td>node-010010013103</td><td>10.10.13.103</td><td>worker 节点</td><td>kube-proxy,kubelet,kubeadm</td><td>v1.22.5</td></tr><tr><td>node-010010013104</td><td>10.10.13.104</td><td>worker 节点</td><td>kube-proxy,kubelet,kubeadm</td><td>v1.22.5</td></tr><tr><td>node-010010013105</td><td>10.10.13.105</td><td>worker 节点</td><td>kube-proxy,kubelet,kubeadm</td><td>v1.22.5</td></tr><tr><td>node-010010013101</td><td>10.10.13.101, 10.10.13.200 (vip)</td><td>master 节点</td><td>kube-apiserver,kube-scheduler,etcd,kube-controller-manager,kubectl,kubelet,kubeadm,keepalive,haproxy</td><td>v1.22.5</td></tr><tr><td>node-010010013102</td><td>10.10.13.102, 10.10.13.200 (vip)</td><td>master 节点</td><td>kube-apiserver,kube-scheduler,etcd,kube-controller-manager,kubectl,kubelet,kubeadm,keepalive,haproxy</td><td>v1.22.5</td></tr></tbody></table><h2 id="备份" tabindex="-1"><a class="header-anchor" href="#备份"><span>备份</span></a></h2><h3 id="etcd备份" tabindex="-1"><a class="header-anchor" href="#etcd备份"><span>etcd备份</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>https://storage.googleapis.com/etcd/v3.5.15/etcd-v3.5.15-linux-amd64.tar.gz



<span class="token assign-left variable">ETCDCTL_API</span><span class="token operator">=</span><span class="token number">3</span>

etcdctl <span class="token parameter variable">--endpoints</span> <span class="token number">10.81</span>.40.138:2379 <span class="token parameter variable">--cert</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/server.crt <span class="token parameter variable">--key</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/server.key <span class="token parameter variable">--cacert</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/ca.crt member list

<span class="token assign-left variable">ETCDCTL_API</span><span class="token operator">=</span><span class="token number">3</span>

etcdctl <span class="token parameter variable">--endpoints</span> <span class="token number">10.81</span>.40.138:2379 <span class="token parameter variable">--cert</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/server.crt <span class="token parameter variable">--key</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/server.key <span class="token parameter variable">--cacert</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/ca.crt endpoint status


etcdctl <span class="token parameter variable">--endpoints</span> <span class="token number">10.81</span>.40.138:2379 <span class="token parameter variable">--cert</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/server.crt <span class="token parameter variable">--key</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/server.key <span class="token parameter variable">--cacert</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/ca.crt endpoint health

<span class="token assign-left variable">ETCDCTL_API</span><span class="token operator">=</span><span class="token number">3</span>

etcdctl <span class="token parameter variable">--endpoints</span> <span class="token number">10.81</span>.40.138:2379 <span class="token parameter variable">--cert</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/server.crt <span class="token parameter variable">--key</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/server.key <span class="token parameter variable">--cacert</span><span class="token operator">=</span>/etc/kubernetes/pki/etcd/ca.crt snapshot save /filebak/k8s-backup/etcd-new-<span class="token variable"><span class="token variable">\`</span><span class="token function">date</span> +%Y%m%d<span class="token variable">\`</span></span>.db
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="kubernetes备份" tabindex="-1"><a class="header-anchor" href="#kubernetes备份"><span>kubernetes备份</span></a></h3><blockquote><p>master节点+worker节点</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> /filebak
<span class="token function">mount</span> <span class="token number">10.81</span>.248.184:/unity400-nfs-test /filebak
<span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /filebak/k8s-backup
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="主机配置" tabindex="-1"><a class="header-anchor" href="#主机配置"><span>主机配置</span></a></h2><h3 id="配置主机名称" tabindex="-1"><a class="header-anchor" href="#配置主机名称"><span>配置主机名称</span></a></h3><blockquote><p>master 节点2</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>hostnamectl set-hostname k8s-m02.shmtu.edu.cn
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>master 节点3</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>hostnamectl set-hostname k8s-m03.shmtu.edu.cn
...
10.81.250.11 k8s-n01.shmtu.edu.cn
10.81.250.12 k8s-n02.shmtu.edu.cn
10.81.250.13 k8s-n03.shmtu.edu.cn
10.81.250.14 k8s-n04.shmtu.edu.cn
10.81.250.15 k8s-n05.shmtu.edu.cn

# master
10.81.40.138 k8s.shmtu.edu.cn
10.81.40.191 k8s-m02.shmtu.edu.cn
10.81.40.192 k8s-m03.shmtu.edu.cn

# vip
10.81.40.193 lb-k8s.shmtu.edu.cn
EOF</span>
...
yum <span class="token function">install</span> <span class="token parameter variable">-y</span> kubeadm-1.22.5  kubelet-1.22.5 kubectl-1.22.5
...
backend apiserver
    ...
    balance     roundrobin
        server k8s.shmtu.edu.cn <span class="token number">10.81</span>.40.138:6443 check
        server k8s-m02.shmtu.edu.cn <span class="token number">10.81</span>.40.191:6443 check
        server k8s-m03.shmtu.edu.cn <span class="token number">10.81</span>.40.192:6443 check
...
vrrp_instance VI_1 <span class="token punctuation">{</span>
    ...
    virtual_ipaddress <span class="token punctuation">{</span>
        <span class="token number">10.81</span>.40.193/24
    <span class="token punctuation">}</span>
  ...
  ClusterConfiguration: <span class="token operator">|</span>
    apiServer:
      certSANs:
        - lb-k8s.shmtu.edu.cn
        - k8s.shmtu.edu.cn
        - k8s-m02.shmtu.edu.cn
        - k8s-m03.shmtu.edu.cn
        - <span class="token number">10.81</span>.40.193
        - <span class="token number">10.81</span>.40.138
        - <span class="token number">10.81</span>.40.191
        - <span class="token number">10.81</span>.40.192 
      extraArgs:
    ...
    controlPlaneEndpoint: lb-k8s.shmtu.edu.cn:16443 <span class="token comment"># abelit</span>
...
<span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /root/abelit-upgrade/pki/
<span class="token function">mv</span> /etc/kubernetes/pki/apiserver.<span class="token punctuation">{</span>crt,key<span class="token punctuation">}</span> /root/abelit-upgrade/pki/
...
kubectl <span class="token parameter variable">-n</span> kube-system delete pod kube-apiserver-k8s.shmtu.edu.cn
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>更新api-server地址(可选)</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># sed -i &quot;s/oldapiservername/newapiservername/g&quot; \`grep oldapiservername -rl /etc/kubernetes\`</span>

<span class="token function">sed</span> <span class="token parameter variable">-i</span> <span class="token string">&quot;s/10.81.40.138:6443/lb-k8s.shmtu.edu.cn:16443/g&quot;</span> <span class="token variable"><span class="token variable">\`</span><span class="token function">grep</span> <span class="token string">&quot;10.81.40.138:6443&quot;</span> <span class="token parameter variable">-rl</span> /etc/kubernetes<span class="token variable">\`</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>重启服务生效</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker ps |awk &#39;/k8s_kube-|etcd/{print $1}&#39; |xargs docker restart</span>
kubectl <span class="token parameter variable">-n</span> kube-system delete pod  kube-apiserver-k8s.shmtu.edu.cn
kubectl <span class="token parameter variable">-n</span> kube-system delete pod  kube-scheduler-k8s.shmtu.edu.cn 
kubectl <span class="token parameter variable">-n</span> kube-system delete pod  kube-controller-manager-k8s.shmtu.edu.cn
kubectl <span class="token parameter variable">-n</span> kube-system delete pod  etcd-k8s.shmtu.edu.cn
...
data:
  ...
  kubeconfig: <span class="token operator">|</span>
    ...
    - cluster:
        ...
        server: https://lb-k8s.shmtu.edu.cn:16443 <span class="token comment"># abelit</span>
...
<span class="token function">sed</span> <span class="token parameter variable">-i</span> <span class="token string">&#39;s/10.81.40.138:6443/lb-k8s.shmtu.edu.cn:16443/g&#39;</span> /etc/kubernetes/kubelet.conf
...
<span class="token function">sed</span> <span class="token parameter variable">-i</span> <span class="token string">&#39;s/10.81.40.138:6443/lb-k8s.shmtu.edu.cn:16443/g&#39;</span> /etc/kubernetes/controller-manager.conf
...
<span class="token function">sed</span> <span class="token parameter variable">-i</span> <span class="token string">&#39;s/10.81.40.138:6443/lb-k8s.shmtu.edu.cn:16443/g&#39;</span> /etc/kubernetes/scheduler.conf
...
data:
  ...
  kubeconfig.conf: <span class="token operator">|</span>-
    ...
    - cluster:
        ...
        server: https://lb-k8s.shmtu.edu.cn:16443
      name: default
    contexts:
    - context:
        cluster: default
...
kubeadm <span class="token function">join</span> lb-k8s.shmtu.edu.cn:16443 <span class="token parameter variable">--token</span> 57u0ys.c6ofplbw94h1uar1 --discovery-token-ca-cert-hash sha256:ff435eeddb1c9c50bfc0f4e3e2920e5be1d1afa0240fa13c792dbba9e0acb882 --control-plane --certificate-key 67bb1be2f31ff1acb1bbf790ededb815c5445c80582adab663386ff4f9a5d368
...
yum <span class="token function">install</span> <span class="token parameter variable">-y</span> bash-completion
