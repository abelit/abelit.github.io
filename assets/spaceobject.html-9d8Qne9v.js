import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,f as e}from"./app-CdMwPPw7.js";const t={},p=e(`<h2 id="管理空间与对象" tabindex="-1"><a class="header-anchor" href="#管理空间与对象"><span>管理空间与对象</span></a></h2><ul><li>查询</li></ul><div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="token keyword">select</span> <span class="token operator">*</span> <span class="token keyword">from</span> dba_advisor_definitions<span class="token punctuation">;</span> 
